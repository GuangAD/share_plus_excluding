...
internal class Share(
    ...
    fun share(text: String, subject: String?,excluding: List<String>?, withResult: Boolean) {
        ...
        if (excluding != null) shareIntent.putExtra(Intent.EXTRA_EXCLUDE_COMPONENTS, excluding)
